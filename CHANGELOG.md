...
## [2.0.11]
- Enhance AJAX calls with additional `current_user_can` security checks

## [2.0.10]
- Fix caching issue for update checks
- Fix bug when themes/plugins API response array is empty

## [2.0.9]
- Maintenance: dependency updates and code quality improvements
